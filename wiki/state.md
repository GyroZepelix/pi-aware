...
| --- | --- | --- | --- | --- | --- |
| `https://git.dgjalic.com/dgjalic/repo-wiki-template` | Protocol version 1 template installer | Forgejo repository | 2026-09-04 | `AGENTS.md`, `spec/`, `wiki/` | Installed lean repo wiki template. |
